...
from app.graphs.sk_assistant import create_assistant_graph
...
def send_message():
    ...
    try:
        latest_state = assistant_graph.get_state(config)
    ...
    try:
        result = loop.run_until_complete(assistant_graph.ainvoke(state, config))
